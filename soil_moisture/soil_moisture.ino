...
//Declarions for OLED and interrupt ends
...
os_runloop_once();
            ...
            }  //This if condition is used process the interrupt triggered when the board is not in sleep mode 
...
LowPower.powerDown(SLEEP_8S, ADC_OFF, BOD_OFF);
          ...
          }  //This if condition is used to process the interrupt triggered when the board entered sleep mode and display process to begin
...
//This section is used to process the interrupt triggered on 10th pin
ISR(PCINT0_vect) {
